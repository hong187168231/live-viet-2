...
CREATE TABLE `sys_dept`  (
  ...
  `parent_id` int NULL DEFAULT 0 COMMENT '父节点id',
...
INSERT INTO `sys_dict_item` VALUES (38, '系统服务', 'live-admin', 'micro_service', 1, 1, 0, '', '2021-06-17 00:14:12', '2021-06-17 00:14:12');
INSERT INTO `sys_dict_item` VALUES (39, '会员服务', 'live-ums', 'micro_service', 2, 1, 0, '', '2021-06-17 00:15:06', '2021-06-17 00:15:06');
INSERT INTO `sys_dict_item` VALUES (40, '商品服务', 'live-pms', 'micro_service', 3, 1, 0, '', '2021-06-17 00:15:26', '2021-06-17 00:16:18');
INSERT INTO `sys_dict_item` VALUES (41, '订单服务', 'live-oms', 'micro_service', 4, 1, 0, '', '2021-06-17 00:15:40', '2021-06-17 00:16:10');
INSERT INTO `sys_dict_item` VALUES (42, '营销服务', 'live-sms', 'micro_service', 5, 1, 0, '', '2021-06-17 00:16:01', '2021-06-17 00:16:01');
...
) ENGINE = InnoDB AUTO_INCREMENT = 82 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_permission
-- ----------------------------
INSERT INTO `sys_permission` VALUES (1, '查看用户', 2, 'GET:/live-admin/api/v1/users/*', 'admin:user:view', '2021-02-02 14:16:07', '2021-06-16 22:25:24');
INSERT INTO `sys_permission` VALUES (74, '编辑用户', 2, 'PUT:/live-admin/users/*', 'admin:user:edit', '2021-06-16 16:19:44', '2021-06-16 23:36:53');
INSERT INTO `sys_permission` VALUES (75, '新增用户', 2, 'POST:/live-admin/api/v1/users', 'admin:user:add', '2021-06-16 23:36:37', '2021-06-16 23:37:03');
INSERT INTO `sys_permission` VALUES (76, '删除用户', 2, 'DELETE:/live-admin/api/v1/users/*', 'admin:user:delete', '2021-06-16 23:43:54', '2021-06-16 23:43:54');
...
) ENGINE = InnoDB AUTO_INCREMENT = 83 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色表' ROW_FORMAT = DYNAMIC;
