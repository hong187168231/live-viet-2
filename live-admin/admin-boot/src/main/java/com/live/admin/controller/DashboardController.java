package com.live.admin.controller;

import cn.hutool.core.convert.Convert;
import cn.hutool.core.util.StrUtil;
import com.live.admin.pojo.domain.LoginRecord;
import com.live.admin.service.ITokenService;
import com.live.common.base.BaseDocument;
import com.live.common.elasticsearch.service.ElasticSearchService;
import com.live.common.result.Result;
import com.live.common.web.util.IPUtils;
...
public class DashboardController {
    ...
    private long getTotalIpCount() {
        long totalIpCount = elasticSearchService.countDistinct(null, "clientIP.keyword", "live-auth-login-*");
        return totalIpCount;
    }
