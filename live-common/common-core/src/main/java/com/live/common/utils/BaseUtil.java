...
public class BaseUtil {
    ...
    public static void writer401Response(HttpServletResponse response, ResultCode  resultCode) throws IOException {
        writerResponse(response, resultCode.getCode(), resultCode.getMsg());
    }
